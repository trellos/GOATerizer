 ...
 *
 * The first scenario built from third-party art rather than generated
 * placeholders — see `docs/assets/ASSET_SOURCES.md` — and the first authored
 * triplet content in the game, so it is also the first thing that selects the
 * drum kit's triplet rhythm variant.
 */
