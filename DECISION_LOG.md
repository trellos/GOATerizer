...
#### DECISION-041: Pentatonic material is authored as pentatonic, resolved by the run's mode, and written to fit the octave rather than folded into it
* **Date:** 2026-09-02
* **Status:** Accepted
* **Owner:** Trevor (agent-assisted)
* **Note:** Numbered past `main`'s highest (DECISION-040) rather than against this branch's own log, which restarts at 023. Both branches allocated numbers concurrently; a gap is cheaper than a duplicate, as DECISION-039 records.
...
#### DECISION-042: A PERFORM scenario's flourishes are authored per note, and the crowd is spectacle that only grows
* **Date:** 2026-09-02
* **Status:** Accepted
* **Owner:** Trevor (agent-assisted)
